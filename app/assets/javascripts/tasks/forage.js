//todo: weld the robots to blocks  http://blog.sethladd.com/2011/09/box2d-collision-damage-for-javascript.html
...
var varyingControlTask = _.extend({}, baseTask, attractiveController, repulsiveController, globalController, {
    ...
    taskMode: "default",
    instructions: "",
    theScience: '<a href="http://en.wikipedia.org/wiki/Forage_(honey_bee)">Foraging</a>, or searching for food and provisions, is how many swarms survive.'
    +' This experiment compares foraging with different controllers, modeled after real-world devices. '
    ...
    +'<a href="https://sites.google.com/site/aabecker/Becker2013b.pdf">our paper.</a>'
    +"</p>",
    ...
    setupInstructions: function ( options ){
        ...
        this.instructions += " Play all "+that._taskModes.length+" control styles!"            //+ "<p> Current mode: <strong>" + that.taskMode + "</strong> control."
        +"<div class='btn-group'>";
