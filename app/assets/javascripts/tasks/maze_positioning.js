var mazePositioningTask = _.extend({}, baseTask, baseController, {
    ...
    theScience: 'Transport of goods and materials between points is at the heart of all engineering and construction in real-world systems.  This experiment varies the number of robots used to transport an object. <div class="view">We keep the total area, maximum robot speed, and sum force the swarm can produce constant. See <a href="http://www.youtube.com/watch?v=px5RdSvGD2Q"> our video of robots pushing a model piano</a>, or <a href="http://mrsl.rice.edu/sites/mrsl.rice.edu/files/papers/MassiveUniformManipulation_0.pdf">our paper</a>  for details.</div>',
