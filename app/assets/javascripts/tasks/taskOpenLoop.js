//todo: This file moves robots in an open-loop path
//  1.) remove obstacles
//      remove code about goals and food, etc.
//  2.) start with 1 robot
//  3.) call the openloop controller
//  4.) add more robots
//

var varyingControlTask = _.extend({}, baseTask, attractiveController, repulsiveController, globalController, {
    taskName: "taskOpenLoop",
    taskMode: "default",
    instructions: "",
    theScience: 'New task',

    _numrobots: 5, //Math.floor((Math.random()*500)+1),           // number of robots
    _robotRadius: 0.5,
    ...
    setupTask: function( options ) { 
        ...
        // create some robots
        this._robotRadius = 0.5*6.0/Math.sqrt(100);
