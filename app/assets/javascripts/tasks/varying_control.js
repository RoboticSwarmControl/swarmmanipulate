var varyingControlTask = _.extend({}, baseTask, attractiveController, repulsiveController, globalController, {
    ...
    theScience: 'We want to use swarms of robots to build micro devices.  This experiment compares different controllers, modelled after real-world devices. <div class="view"> Scientists are using scanning tunneling microscopes (STM) to arrange atoms and make small assemblies.  A very tiny microscope tip is charged with electrical potential, and this charge can be used to repulse like-charged atoms or attract differently-charged atoms. The global controller represents using global field (formed by parallel lines of diffferently-charged conductors) to pull atoms all in the same direction. See <a href="http://www.youtube.com/watch?v=px5RdSvGD2Q">video of a global controller</a>, or <a href="http://mrsl.rice.edu/sites/mrsl.rice.edu/files/papers/MassiveUniformManipulation_0.pdf">our paper</a>  for details.</div>',
