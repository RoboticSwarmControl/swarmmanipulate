...
%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%
\input{relatedWork6pages}
%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%
\input{expMethods6pages}
%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%
\input{expResults6pages}
%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%
\input{discussion6pages}
%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%
\input{conclusion6pages}
%%%%%%%%%%%%%%%
...
%   %To Decrease the space between bibliography items.
%\let\realbibitem=\bibitem
%\def\bibitem{\par \vspace{-.5ex}\realbibitem}
